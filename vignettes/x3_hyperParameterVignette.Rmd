...
* *new starting in v0.4.0*: A version of the Expectation-Maximization (EM)
Algorithm known as the Expectation/Conditional Maximization (ECM) Algorithm
(*1*)

*openEBGM*'s functions (prior to v0.4.0) use multiple starting points and local
optimization algorithms implemented in R's *stats* package. The user is
encouraged to explore a variety of optimization approaches because the accuracy
of a global optimization result is extremely difficult to verify and other
approaches might work better in some cases.
...
*John Wiley & Sons, Ltd*, 111-112. https://doi.org/10.1002/9780470094846
